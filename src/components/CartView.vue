...
<template>
  ...
  <div class="mainPage m-auto p-5 d-flex justify-content-between">
    <div class="product d-flex flex-column">
      ...
      <div
        class="prod-card w-100 d-flex justify-content-between align-items-center"
      >
        <div class="img">
        ...
        <RouterLink to="/singleProduct"><h2>Asgaard sofa</h2></RouterLink>
        <h2>Rs. 250,000.00</h2>
        <h2 class="one py-1 px-2">1</h2>
        <h2>Rs. 250,000.00</h2>
