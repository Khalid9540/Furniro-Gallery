...
<template>
  ...
  <div class="thehead m-auto d-flex justify-content-between py-5">
    <div class="imgs d-flex justify-content-between">
      <div class="icons d-flex flex-column">
        <img
          src="@/assets/imgs/e8e6980ec9e9224b3002d53824688ecee9c882c5.png"
          alt=""
        />
        <img
          src="@/assets/imgs/4d654cce148fae44b3bf6e9ac8ce6743c19e7de6.png"
          alt=""
        />
        <img
          src="@/assets/imgs/83ef229324c656816d67a755100ac5f664833551.png"
          alt=""
        />
        <img
          src="@/assets/imgs/75ae609a0c46ac4eb9c274966b1133cb71128f16.png"
          alt=""
        />
      </div>
      <div class="main-img">
        <img
          src="@/assets/imgs/2ac413c1917ac944454e358f73d0af67e1f1b74e.png"
          alt=""
        />
      </div>
    </div>
  ...
  <div class="description d-flex flex-column m-auto py-5">
    ...
    <div class="imgsDisplay d-flex justify-content-between w-100">
      <img
        src="../assets/imgs/b7395be53f5927c3cf50e945c3e0f03b3206e810.png"
        alt=""
        class="mt-4"
      />
      <img
        src="../assets/imgs/1421901b217b5f7ea72cbcd9ce3062c4165744e5.png"
        alt=""
        class="mt-4"
      />
    </div>
  ...
  <hr />
  <div
    class="related-products d-flex flex-column m-auto py-5 align-items-center"
  >
    ...
    <RouterLink to="/shop" class="btn py-2 px-5">Show More</RouterLink>
  </div>
</template>
<style scoped>
.filter {
